...
As we kick off the hackathon we'd like to cover a few topics:   
1. Diversity Alliance: background, goals and joining.    
2. Housekeeping for the hackathon  
3. Mentor intros  
4. Intro to open-source: tooling  
5. Intro to open-source: expected behaviours  

<div >

```{=html}
<iframe class="slide-deck" src="slides/" style="width:80%; height:500px"></iframe>
```
